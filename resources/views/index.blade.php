                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
                        <div class="pst-single-card text-center ">
                            <div class="card-top">
                                <img height="100px" width="100px" src="{{ asset('img/elements/target.png') }}" alt="">
         ...
         <div class="brand-area">
            <div class="container">
                <div class="brand-active brand-border pt-20 pb-20 pst-mx-50">
                    ...
                    <div class=" pst-min-card">
                        <img  height="50px" width="80px" src="{{ asset('img/gallery/zong.png') }}" alt="">
                    </div>
                    <div class=" pst-min-card">
                        <img  height="50px" width="60px" src="{{ asset('img/gallery/warid.png') }}" alt="">
                    </div>
                    <div class=" pst-min-card">
                    ...
                    <div class="h1-testimonial-active dot-style">
                        ...
                        <div class="single-testimonial ">
                            <div class="testimonial-caption ">
                                ...
                                <div class="testimonial-founder">
                                    <div class="founder-img mb-40">
                                        <img class="pst-round" height="150px" width="150px" src="{{ asset('img/gallery/team2.png') }}" alt="">
                                    </div>
                                </div>
                                <div class="testimonial-top-cap">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-features mb-40">
                            <div class="features-icon">
                                <img height="40px" width="40px" src="{{ asset('img/gallery/unlock-growt.png') }}" alt="">
                            </div>
                            <div class="features-caption">
                                <h3>Unlock Growth</h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-features mb-40">
                            <div class="features-icon">
                                <img height="40px" width="40px" src="{{ asset('img/gallery/target.png') }}" alt="">
                            </div>
                            <div class="features-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-features mb-40">
                            <div class="features-icon">
                                <img height="40px" width="40px" src="{{ asset('img/gallery/d.png') }}" alt="">
                            </div>
                            <div class="features-caption">
